...
proc create_hier_cell_iop_arduino { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 0 -to 0 Op1_0
  create_bd_pin -dir I -from 0 -to 0 -type rst aux_reset_in
  create_bd_pin -dir I -type clk clk_100M
  ...
  # Create port connections
  connect_bd_net -net Op1_0_1 [get_bd_pins Op1_0] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins axi_uartlite_0/rx] [get_bd_pins util_vector_logic_0/Res]
...
proc create_root_design { parentCell } {
  ...
  set uart_in [ create_bd_port -dir I -from 0 -to 0 uart_in ]
  ...
  # Create port connections
  connect_bd_net -net Op1_0_1 [get_bd_ports uart_in] [get_bd_pins iop_arduino/Op1_0]
