...
--               d:/Pynq/PYNQ_V2.1/boards/Pynq-Z1/base/base/base.srcs/sources_1/bd/system/ip/system_concat_interrupts_0/system_concat_interrupts_0_sim_netlist.vhdl
...
entity system_concat_interrupts_0 is
  ...
  attribute X_CORE_INFO of system_concat_interrupts_0 : entity is "xlconcat_v2_1_1_xlconcat,Vivado 2017.4";
...
begin
  ...
  dout(12) <= \^in5\(0);
  dout(11) <= \^in4\(0);
  dout(10 downto 8) <= \^in3\(2 downto 0);
  dout(7) <= \^in2\(0);
  dout(6) <= \^in1\(0);
