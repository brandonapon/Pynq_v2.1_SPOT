...
class ViewState(SPOT):
	...
	def __init__(self, parent):
		...
		point = parent.radar.points.get(self.select)
		print('point made')
		print('x:', point.markedLocation[0])
		print('y:', point.markedLocation[1])
